...
**Status:** live as of P7. 819 tests, fully offline and deterministic.
...
**Current:** 819 passed offline (~5.2s), plus 5 `live` tests that pass against the real provider when run deliberately.
